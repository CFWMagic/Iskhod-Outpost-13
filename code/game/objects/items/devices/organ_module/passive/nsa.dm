/obj/item/organ_module/viv_bank
	...
	desc = "A small boxy implant that is attached to the connection point of the skull and the spine with a series of small needle-like cables and electrodes, helping \
