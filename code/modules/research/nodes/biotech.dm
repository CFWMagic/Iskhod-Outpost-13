...
/datum/technology/basic_medical_tools
	...
	desc = "Mass Spectrometry method. Experimental surgical, laser tools. Medical sensors integrated HUD in hud-glass and large revival electrical shocks. Artificial quick dry bone gel composite."
	tech_type = RESEARCH_BIOTECH
